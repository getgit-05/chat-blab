              ...
              <div className="absolute left-0 w-full bg-zinc-900 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto border border-zinc-800 animate-fade-in" style={{ top: 'calc(100% + 8px)' }}>
                {loading ? (
                  ...
                  results.map(user => (
                    ...
                    >
                      <img src={user.profileImageUrl || "https://res.cloudinary.com/du9bkkccq/image/upload/v1752337424/t58jiptx00gqj34a8eh8.svg"} alt={user.name} className="w-8 h-8 rounded-full border" />
